function Startblog({ onStartBlog }) {
  return (
    <div className="w-[723px] h-[107px] bg-[#1B1826] flex flex-col items-start justify-center px-7">
      ...
      <div className="flex mt-3 flex-row items-center">
        ...
        />
        <div
          className="w-[630px] h-[35px] font-lexend bg-[#372F51] text-gray-400 cursor-pointer rounded-[15px] ml-4 flex items-center justify-left pl-3"
          onClick={onStartBlog} // Callback for triggering the TalkBlog component
        >
